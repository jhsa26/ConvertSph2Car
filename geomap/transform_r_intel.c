...
void fpos(float del,float az,float wlat, float wlon, float *lat,float *lon); 
void locate(double oldlat,double oldlon,double angd,double az,double *newlat,double *newlon);
float get_az(float,float);
geome mygrt(double elt,double eln,double slt,double sln);
void rot2(double oldlat,double oldlon,double angle,double *newlat,double *newlon);
void rot3(double oldlat,double oldlon,double angle,double *newlat,double *newlon);
